            ...
            <motion.div variants={slideFrom} className="w-full md:w-2/5 flex-shrink-0">
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            background: `linear-gradient(to top, rgba(11,22,40,0.65) 0%, rgba(11,22,40,0.1) 45%, transparent 70%)`,
                        }}
                    />
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 text-center whitespace-nowrap">
                        <span
